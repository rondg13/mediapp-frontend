...
import { SignoVitalDialogComponent } from './pages/signo-vital/signo-vital-dialog/signo-vital-dialog.component';
import { AgregarComponent } from './pages/signo-vital/agregar/agregar.component';
...
@NgModule({
  declarations: [
    ...
    PerfilComponent,
    SignoVitalComponent,
    SignoVitalDialogComponent,
    AgregarComponent,
    PacienteModalComponent   
  ],
  entryComponents: [MedicoDialogoComponent, DialogoComponentComponent, SignoVitalDialogComponent, PacienteModalComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
